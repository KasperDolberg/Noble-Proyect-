              ...
              <div className="config-content">
                ...
                <div className="container__title">
                  ...
                  <div className="exterior__container">
                      ...
                      <div style={{ backgroundColor: '#004225'}}> </div>
                      <div style={{ backgroundColor: '#030B2F' }}></div>
                  ...
                  <div className='img__box'>
                      <div>
                        <img src='/src/img/Configure/m200_interior.jpeg' alt="wheel image" />
                        <h3 className='text__price'>Black Nappa leather</h3>
                      </div>
                  </div>
                  </div>
                  ...
                  <div className='img__box'>
                      <div>
                        <img src='/src/img/Configure/m200-wheels.jpeg' alt="wheel image" />
                        <h3 className='text__price'>20" Gloss Black Ultra-lightweight</h3>
                      </div>
                  </div>
                  </div>
                  <div className="line-grey"></div>
