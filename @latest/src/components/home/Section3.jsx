    ...
    import '/src/stylesheets/Section3.css';
    import { Link } from 'react-router-dom'

    const section3 = () => {
        
        const slides = [
            { url: '/src/img/IMG2PRUEBA.jpg', name: 'E Target', description: 'The redefinition of a sports car', price: '$140000', },
            { url: '/src/img/IMG1PRUEBA.jpg', name: 'M 200', description: 'A desing from the near future', price: '$80000', },
            { url: '/src/img/IMG3PRUEBA.jpg', name: 'E 300', description: 'The electric SUV', price: '$67000', },
          ];
